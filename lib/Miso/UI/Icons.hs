...
-----------------------------------------------------------------------------
arrowLeftIcon :: [Attribute model action] -> View context props model action
arrowLeftIcon attrs = lucide_ attrs
  [ S.path_ [ SP.d_ "m12 19-7-7 7-7" ]
  , S.path_ [ SP.d_ "M19 12H5" ]
  ]
-----------------------------------------------------------------------------
arrowRightIcon :: [Attribute model action] -> View context props model action
arrowRightIcon attrs = lucide_ attrs
  [ S.path_ [ SP.d_ "M5 12h14" ]
  , S.path_ [ SP.d_ "m12 5 7 7-7 7" ]
  ]
-----------------------------------------------------------------------------
checkIcon :: [Attribute model action] -> View context props model action
checkIcon attrs = lucide_ attrs
  [ S.path_ [ SP.d_ "M20 6 9 17l-5-5" ]
  ]
-----------------------------------------------------------------------------
chevronDownIcon :: [Attribute model action] -> View context props model action
chevronDownIcon attrs = lucide_ attrs
  [ S.path_ [ SP.d_ "m6 9 6 6 6-6" ]
  ]
-----------------------------------------------------------------------------
chevronLeftIcon :: [Attribute model action] -> View context props model action
chevronLeftIcon attrs = lucide_ attrs
  [ S.path_ [ SP.d_ "m15 18-6-6 6-6" ]
  ]
-----------------------------------------------------------------------------
chevronRightIcon :: [Attribute model action] -> View context props model action
chevronRightIcon attrs = lucide_ attrs
  [ S.path_ [ SP.d_ "m9 18 6-6-6-6" ]
  ]
-----------------------------------------------------------------------------
chevronsUpDownIcon :: [Attribute model action] -> View context props model action
chevronsUpDownIcon attrs = lucide_ attrs
  [ S.path_ [ SP.d_ "m7 15 5 5 5-5" ]
  , S.path_ [ SP.d_ "m7 9 5-5 5 5" ]
  ]
-----------------------------------------------------------------------------
circleAlertIcon :: [Attribute model action] -> View context props model action
...
-----------------------------------------------------------------------------
circleCheckIcon :: [Attribute model action] -> View context props model action
circleCheckIcon attrs = lucide_ attrs
  [ S.circle_ [ SP.cx_ "12", SP.cy_ "12", SP.r_ "10" ]
  , S.path_ [ SP.d_ "m9 12 2 2 4-4" ]
  ]
-----------------------------------------------------------------------------
dotsIcon :: [Attribute model action] -> View context props model action
...
-----------------------------------------------------------------------------
downloadIcon :: [Attribute model action] -> View context props model action
...
-----------------------------------------------------------------------------
infoIcon :: [Attribute model action] -> View context props model action
...
-----------------------------------------------------------------------------
loaderIcon :: [Attribute model action] -> View context props model action
...
-----------------------------------------------------------------------------
searchIcon :: [Attribute model action] -> View context props model action
searchIcon attrs = lucide_ attrs
  [ S.circle_ [ SP.cx_ "11", SP.cy_ "11", SP.r_ "8" ]
  , S.path_ [ SP.d_ "m21 21-4.3-4.3" ]
  ]
-----------------------------------------------------------------------------
sendIcon :: [Attribute model action] -> View context props model action
...
-----------------------------------------------------------------------------
trashIcon :: [Attribute model action] -> View context props model action
...
-----------------------------------------------------------------------------
uploadIcon :: [Attribute model action] -> View context props model action
...
-----------------------------------------------------------------------------
xIcon :: [Attribute model action] -> View context props model action
