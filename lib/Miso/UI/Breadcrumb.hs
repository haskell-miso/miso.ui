...
-----------------------------------------------------------------------------
breadcrumbSeparator_ :: View context props model action
breadcrumbSeparator_ =
  H.li_ [] [ chevronRightIcon [ P.class_ "size-3.5" ] ]
-----------------------------------------------------------------------------
breadcrumbSample :: View context props model action
breadcrumbSample =
...
-----------------------------------------------------------------------------
breadcrumbCodeSample :: View context props model action
breadcrumbCodeSample =
  """
  -----------------------------------------------------------------------------
  ...
  """
-----------------------------------------------------------------------------
breadcrumbPropsApi :: View context props model action
breadcrumbPropsApi =
  """
  -- | Props for 'breadcrumb_'
  data BreadcrumbProps model action
